...
import { Star, GitFork, Eye, ExternalLink, Github, Code2, Trophy, Flame, ArrowRight } from "lucide-react";
...
export default function GitHubTrendingShowcase() {
  ...
  return (
    <section id="github-section" className="mb-12">
